...
const LearningGrid = () => {
  return (
    <div>
        <div className='grid mx-auto grid-col-1 lg:grid-cols-4 mb-10 p-5'>
            {
                LearningGridArray.map((card, index) => {
                    return(
                        <div key={index} className={`${index === 0 && "lg:col-span-2 lg:h-[280px] p-5 lg:w-fit"} ${card.order%2 === 1 ? "bg-richblack-700 lg:h-[280px] p-5" : "bg-richblack-800 lg:h-[280px] p-5"} ${card.order === 3 && "lg:col-start-2 lg:h-[280px] p-5"} ${card.order < 0 && "bg-transparent"}`}>
                            {
                                card.order < 0
